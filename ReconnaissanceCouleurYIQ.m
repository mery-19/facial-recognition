function ReconnaissanceCouleurYIQ()
...
%%Apprentisage 
disp(' La reconnaissance Couleur YIQ (2,12) et le parametre de mapping classique:');
comp_train=1;
comp_test=1;

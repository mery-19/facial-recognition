function attribut = ExtractionLbpCouleurVisage(image,rayon,nb_voisin)
    ...
    %extraction lbp
    attribut_R=lbp(R,rayon,nb_voisin,0,'nh');
    attribut_G=lbp(G,rayon,nb_voisin,0,'nh');
    attribut_B=lbp(B,rayon,nb_voisin,0,'nh');

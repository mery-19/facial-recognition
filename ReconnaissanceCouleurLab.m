function ReconnaissanceCouleurLab()
...
%%Apprentisage 
disp(' La reconnaissance Couleur Lab (2,12) et le parametre de mapping classique:');
comp_train=1;
comp_test=1;
